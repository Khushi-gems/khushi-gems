  ...
  (
    {
      side = "left",
      variant = "sidebar",
      collapsible = "none", // Changed default to 'none'
      className,
      children,
      ...props
    },
    ...
    if (collapsible === "none") {
      return (
        <aside
          className={cn(
            "sticky flex-shrink-0 h-fit flex-col bg-background text-sidebar-foreground",
            className
          )}
          ref={ref}
          {...props}
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      {...props}
    >
      {props.asChild ? props.children : <PanelLeft />}
    </Comp>
  )
})
